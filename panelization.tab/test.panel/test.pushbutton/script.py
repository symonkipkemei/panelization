...
if __name__ == "__main__":
    # test window index
    #t.test_centre_window_index(__title__, window_option=False)
    #t.test_fenestration_edges(__title__, window_option=False)
    #t.test_out_ranges(__title__, 0.5, window_option=True)
    #g.remove_graphics(__title__)
    ff.switch_option()
